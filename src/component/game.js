export default function() {
	...
	function create() {
	    ...
	    //  The hero!
	    player = game.add.sprite(window.innerWidth   / 2, 500, 'ship');
	    ...
	    game.add.text(game.world.width - 115, 10, 'Vidas ', { font: '30px Arial', fill: '#fff' });
	...
	function createAliens () {
	    ...
	    for (var y = 0; y < 4; y++)
	    {
	        for (var x = 0; x < 10; x++)
	        {
	            ...
	            alien.animations.add('fly', [ 0, 1, 2, 3 ], 200, true);
	            alien.play('fly');
	            alien.body.moves = false;
	        }
	    }

	    aliens.x = 100; //window.innerWidth / 2;
	    aliens.y = 50;
	...
	function update() {
	    ...
	    if (player.alive)
	    {
	        ...
	        if (cursors.left.isDown && player.body.x > 4)
	        {
	            player.body.velocity.x = -200;
	        }
	        else if (cursors.right.isDown && player.body.x < 769)
	        {
	            player.body.velocity.x = 200;
	        }
	...
	function enemyFires () {
	    ...
	    if (enemyBullet && livingEnemies.length > 0)
	    {
	        ...
	        firingTimer = game.time.now + EnemyFireSpeedy;
	    }
